...
?>
          ...
          <!--			<input type="submit" value="View Details" name="btnviewdetails">      -->   
                            ...
                            <tr>
                                <td>Course Title</td>
                                <td>:</td>
                                <td><input type="text" value="<?php if (isset($cnm) && $cnm != "") echo $cno . " " . $cnm; ?>"  size="70"></td>
                            </tr>
                            <tr>
                                <td>Credit Hours</td>
                                <td>:</td>
...
for ($i = 1; $i <= 12; $i++) {
    ...
    ?>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <textarea name="tacdetails" rows="10" cols="50" <?php if ($special == false) {
                                        echo "disabled";
                                    } ?>>
                                        <?php
                                        if (isset($desc) && $desc != "") {
...
if ($cnt > 0) {
    ...
    while ($info3 = mysqli_fetch_assoc($data3)) {
        ?>
                                                    <tr>
                                                        ...
                                                        <td><textarea rows="2" name="<?php echo "tacam_$cnt" . "_" . $info3["camid"];
                                ; ?>" cols="40"><?php echo $info3["camdetails"]; ?></textarea></td>
                                                    </tr>	
        <?php
        $cnt++;
    }
    ...
    ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <input type="hidden" value="<?php if (!isset($_POST["btnsubmit"])) {
                                        echo (($cntrec1 > 0) ? $cntrec1 : 3);
                                    } ?>" name="hfcamtot" id="hfcamtot" />
...
<?php if (isset($attp) && $attp != "") echo $attp;
else { ?>
...
?>
                            ...
                            <tr>
                                <td colspan="3" align="center">
                                    <button type="submit" id="btnsubmit" name="btnsubmit"<?php if ($_POST["ddlcnm"] == 0) {
                                        echo " disabled";
                                    } ?>>Proceed to Course Assessment Method Mappings</button>
                                </td>
                            </tr>
                        </table>
                    </form>
